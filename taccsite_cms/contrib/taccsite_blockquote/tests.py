...
from taccsite_cms.contrib.taccsite_blockquote.cms_plugins import TaccsiteBlockquotePlugin
from taccsite_cms.contrib.taccsite_blockquote.models import TaccsiteBlockquote

class TaccsiteBlockquoteTests(TestCase):
    def setUp(self):
