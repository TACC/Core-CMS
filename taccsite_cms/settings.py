...
if 'PORTAL_ES_ENABLED' in locals(): print('PORTAL_ES_ENABLED', PORTAL_ES_ENABLED)
if 'INSTALLED_APPS' in locals(): print('INSTALLED_APPS', INSTALLED_APPS)
if 'es_search_INSTALLED_APPS' in locals(): print('es_search_INSTALLED_APPS', es_search_INSTALLED_APPS)
